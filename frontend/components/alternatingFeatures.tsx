...
const AlternatingFeatures: React.FC = () => {
  return (
    <section className="bg-white border-b md:pt-8 md:pb-8">
      <div className="container max-w-5xl mx-auto m-8">
        <TitleBar>Examinations Done Correctly</TitleBar>
        <div className="flex flex-wrap">
          <div className="w-5/6 sm:w-1/2 p-6 flex-grow">
        ...
        <div className="flex flex-wrap flex-col-reverse sm:flex-row">
          <div className="w-full sm:w-1/2 p-6 md:mt-6 flex-grow">
            <div className="max-w-lg">
              <GraphSVG />
            </div>
          </div>
          <div className="w-full sm:w-1/2 p-6 md:mt-6">
