...
const NavigationBar = ({ title = config.appName, children }) => (
  <header className="text-white bg-green-900 body-font shadow w-full mb-6">
    <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <div className="hidden md:block inline-flex md:ml-5 lg:ml-0">
        <Link href="/signin">
          <button className="bg-green-700 hover:bg-green-500 text-white border border-green-900 mt-4 md:mt-0 md:ml-4 py-2 px-3 rounded-lg">
            Sign In
          </button>
        </Link>
      </div>
